            ...
            <div class="container">
                ...
                <div class="building-desc">
                    <div class="slider" style="max-height:380px;overflow:hidden;">
                        ...
                        <div style="border:solid 0px red;padding:5px;float:right;">
                        @if(Auth::user()->isAgent())
                        <div class="logo-listed" style="float:right;margin-bottom:10px;cursor:pointer;color:#4577b9;" {{--onclick="window.location='/agent/{{str_replace(' ', '_', $agent_infos->full_name)}}/{{$agent_infos->id}}';"--}} onclick="window.location='/agent/John_Smith/23883';">
                            <p style="width:77px;height:77px;display:block;position:relative;overflow: hidden;border-radius: 50%;background-image: url(/images/agent_sample.jpg);background-size:cover;background-position:top center;">   
                            </p>
                            <div style="font-size:20px;float:left;text-align:left;"><i>{{--$agent_infos->full_name--}}John Smith</i></div>
                            <div style="clear:both;"></div>
                            <div style="font-size:20px;float:left;font-weight:bold;white-space: nowrap;"><i>{{--@if($agent_infos->company){{$agent_infos->company}}@else Company Logo @endif--}}Paradise Realty</i></div>
                        </div>
                        <div style="float:right;margin-right:15px;margin-top:6px;cursor:pointer;" onclick="window.location='/agent/{{str_replace(' ', '_', $agent_infos->full_name)}}/{{$agent_infos->id}}';">
                            Provided By:<br>
                ...
                <div class="content-side building">          
                    ...
                    <div class="description">
                        ...
                        <span class="dmore">Carefully crafted with the theme of contemporary urban life “reimagined”, The Aldyn offers its residents sophisticated Manhattan condominium living combined with unrivalved amenities on a scale never before attempted in New York City residential real estate. The building extends forty stories, and is comprised of 290 luxury residences with 136 apartments available exclusively for lease. Commencing on the eleventh floor, discerning owners have a choice of unique and spacious floor plans designed with one to seven bedrooms and sizes ranging from 700 square feet to 6700 square feet.

Influenced by Italian Modernism and infusing contemporary elegance, highly celebrated Standard and Ace Hotel designers Roman/Williams have tastefully executed their unique vision by providing choices of warm teak wood or white lacquer kitchens, integrated custom dish racks, rare solid teak powder room

sinks, as well as luxurious teak wrapped master baths.

The Aldyn exceeds every expectation for a Manhattan residential building athletic club with the unique 40,000 square foot Aldyn Athletic Club and Spa. Managed exclusively by La Palestra, it offers residents an array of wellness and amenities unmatched virtually anywhere. Offerings include a 38’ rock climbing wall, full basketball court, bowling alley, squash court, PGA golf simulator, spinning, yoga, pilates,kinesis and personal training rooms, Club lounge, game room and one of only five indoor swimming pools in New York City measuring 75 feet.

With an appreciation for the concept of “privacy as the ultimate luxury”, residents also can enjoy the extremely spacious and graciously manicured private outdoor courtyard utilizing the very best of available space, air and light and offering relaxation pods/ nooks that provide a welcome

respite from the often hectic pace of Manhattan life.

Completing the list of conveniences are 24 hour Doorman/Concierge, on -site parking garage, childrens indoor playroom by KidVille, entertainment room with catering kitchen, Riverside South shuttle service,available private storage bins, bicycle room, and lobby lounge area.

The Aldyn is ideally located just minutes from world famous Lincoln Center for the Performing Arts, Riverside Park, Columbus Circle, Central Park, Time Warner Center, and the very best of the upper west side shopping and dining.</span>         
                    </div>          
