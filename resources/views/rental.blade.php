                                ...
                                <div class="fields content" style="margin-top:3.5rem;">
                                    ...
                                    <div class="columns is-variable form-content">
                                        <div class="column">
                                            <div style="margin-bottom:1rem">
                                                ...
                                                <div class="select">
                                                    <select name="status" id="status" class="req-f">                                                                
                                                        ...
                                                        <option value="-2" @if (\Illuminate\Support\Facades\Input::old('status') == '-2' || isset($list) && $list->status == '-2') selected @endif>Pending</option>
                                                        <option value="-3" @if (\Illuminate\Support\Facades\Input::old('status') == '-3' || isset($list) && $list->status == '-3') selected @endif>Rented</option>
                                                    </select>
                                            ...
                                            <div style="margin-top:1rem">
                                                <label class="label" for="">Short Term Renting:</label>
                                                <div class="select">
                                                    <select name="short_term" id="short_term">                                                                
                                                        <option value="0" @if (\Illuminate\Support\Facades\Input::old('short_term') == '0' || isset($list) && $list->short_term == '0') selected @endif>No</option>
                                                        <option value="1" @if (\Illuminate\Support\Facades\Input::old('short_term') == '1' || isset($list) && $list->short_term == '1') selected @endif>Yes</option>
                                                    </select>
                                                </div>
                                            </div>
                                            @if ($errors->has('short_term'))
                                                <span class="help-block">
                                                <strong>{{ $errors->first('short_term') }}</strong>
                                            </span>
                                            @endif
                                        </div>
                                ...
                                <div class="fields content">
                                    ...
                                    <div class="columns is-variable">
                                        <div class="column" style="margin-top:1rem;position:relative;">
                                            ...
                                            <input type="file" name="agreement[]" class="select is-primary ex_agree" value="{{ old('agreement') }}" id="agreement" accept="image/jpeg,image/gif,image/png,.bmp,.svg,application/pdf" multiple>
                                    ...
                                    @if(isset($list) && $list->amazon_id == 1 || !isset($list) || isset($list) && !$list->is_verified)
                                    <div style="font-size:13px;margin-top:30px;">
                                        *Notes:
                                        <ul style="padding-left:15px;">
                                        @if(!isset($list) || isset($list) && !$list->is_verified)<li style="list-style-type:decimal;">Please give us 24 - 48 hours to verify your data. You can still activate your listing in the mean time.</li>@endif
                                        @if(isset($list) && $list->amazon_id == 1)
                                        <li style="list-style-type:decimal;">Your rental listing will be deactivated automatically after 7 days unless it's a feature/premium listing. You will need to login and reactive your listing if you want to continue.</li>
                                        <li style="list-style-type:decimal;">Your rental listing is free for the first month. If you want to continue, you will need to pay for a monthly fee of $10.</li>
                                        @endif
                                        </ul>
                                    </div>
                                    @endif
