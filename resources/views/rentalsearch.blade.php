            ...
            <div class="container">
                ...
                <div class="filter-page">
					<div class="pull-right" style="margin-top:10px;margin-right:10px;">
						<div><a href="#" style="color:#282828;font-size:18px;text-decoration:none;cursor:pointer;text-decoration:underline;display:none;">No Fee Condo Buildings</a></div>
					</div>
                                    ...
                                    <div class="filter-box-content">
                                        ...
                                        <div class="filter-item services">
											...
											<ul class="list">
												...
												<li>
													<input type="checkbox" name="filters[]" class="small-checkbox" id="693" value="693">
													<label style="white-space: nowrap;" for="693">Short Term</label>
												</li>												
												<li>
