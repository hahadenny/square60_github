                        ...
                        @endif
                            ...
                            <form action="{{route('featuring')}}" method="post" id="payment-form" style="width:100%;max-width:550px;margin:0 auto;padding:0 10px;">
                                {{ csrf_field() }}
                                    ...
                                    <h4>Feature Listing ID {{request()->id}}:</h4>
                                    @if(Auth::user()->premium)
                                    <div style="color:red;margin-bottom:15px;">
                                        <i>You will have @if(Auth::user()->premium==1) {{(1-env('SILV_FEAT_DISC'))*100}}% @elseif(Auth::user()->premium==2) {{(1-env('GOLD_FEAT_DISC'))*100}}% @elseif(Auth::user()->premium==3) {{(1-env('DIAM_FEAT_DISC'))*100}}% @endif discount!</i>
                                    </div>
                                    @endif
                                ...
                                <div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div id="card-errors" class="card-errors" role="alert" style="width:90vw;margin-top:10px;color:red">
                                            <span class="message"></span>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        $('input.price').on('change', function() {
            ...
            if($(this).is(":checked")) {
                ...
                var dis_total = total_int * @if(Auth::user()->premium==1) {{env('SILV_FEAT_DISC')}} @elseif(Auth::user()->premium==2) {{env('GOLD_FEAT_DISC')}} @elseif(Auth::user()->premium==3) {{env('DIAM_FEAT_DISC')}} @endif;
