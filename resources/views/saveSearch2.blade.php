                    ...
                    <ul>
                        ...
                        <li class="item" v-on:mouseenter="changeEstateId('feature', {{$key}})" style="min-height:150px;">
                            ...
                            <div class="bg-item" style="overflow:hidden;{{--background-image: @if($feature->img) url({{$feature->img}}); @else url(/images/default_image_coming.jpg); @endif--}}">
                                <img src="@if($feature->img) {{$feature->img}} @else /images/default_image_coming.jpg @endif" style="width:240px">
                            </div>
                            <div class="text-wr">
                                ...
                                <div class="item-time">
                                    ...
                                    @if ($feature->web_site)
                                        @if ($feature->path_to_logo)
                                            <a href="{{$feature->web_site}}" target="_blank" style="cursor:pointer;"><img src="{{$feature->path_to_logo}}" alt="" class="item-logo" style="max-width:150px;max-height:50px;"></a>
                        ...
                        <li class="item" v-on:mouseenter="changeEstateId('result', {{$key}})" style="min-height:150px;">
                            ...
                            <div class="bg-item" style="overflow:hidden;{{--background-image: @if ($result->img) url({{$result->img}}); @else url(/images/default_image_coming.jpg); @endif--}}">
                                <img src="@if($result->img) {{$result->img}} @else /images/default_image_coming.jpg @endif" style="width:240px">
                            </div>
                            <div class="text-wr">
                                ...
                                <div class="item-time">
                                    ...
                                    @if ($result->web_site)
                                        @if ($result->path_to_logo)
                                            <a href="{{$result->web_site}}" target="_blank" style="cursor:pointer;"><img src="{{$result->path_to_logo}}" alt="" class="item-logo" style="max-width:150px;max-height:50px;"></a>
