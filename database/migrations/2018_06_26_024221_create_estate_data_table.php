...
class CreateEstateDataTable extends Migration {
	...
	public function up()
	{
		Schema::create('estate_data', function(Blueprint $table)
		{
			...
			$table->integer('estate_type')->index('estate_type');
			...
			$table->decimal('price', 15)->index('idx_price');
			$table->decimal('last_price', 15);
			...
			$table->integer('user_id')->unsigned()->default(1)->index('user_id');
